...
const Particles = ({ config }) => {
  ...
  const uniforms = useMemo(
    () => ({
      ...
      uParticleRotationSpeed: {
        value: MEDUSAE_DEFAULTS.particles.rotationSpeed,
      },
      uParticleRotationJitter: {
        value: MEDUSAE_DEFAULTS.particles.rotationJitter,
      },
      uParticleOscillationFactor: {
        value: MEDUSAE_DEFAULTS.particles.oscillationFactor,
      },
      uParticleColorBase: {
  ...
  useEffect(() => {
    ...
    material.uniforms.uHaloOuterStartOffset.value =
      merged.halo.outerStartOffset;
    ...
    material.uniforms.uParticleRotationSpeed.value =
      merged.particles.rotationSpeed;
    material.uniforms.uParticleRotationJitter.value =
  ...
  useFrame((state) => {
    ...
    if (hovering.current) {
      ...
      targetX =
        (baseX + jitterX * jitterRadius * merged.cursor.strength) *
        followStrength;
      targetY =
        (baseY + jitterY * jitterRadius * merged.cursor.strength) *
        followStrength;
    }
